...
SW25.races = {
  Human: "SW25.Races.Human",
  Elf: "SW25.Races.Elf",
  Dwarf: "SW25.Races.Dwarf",
  Runefolk: "SW25.Races.Runefolk",
  Nightmare: "SW25.Races.Nightmare",
  Tabbit: "SW25.Races.Tabbit",
  Grassrunner: "SW25.Races.Grassrunner",
  Leprechaun: "SW25.Races.Leprechaun",
  Shadow: "SW25.Races.Shadow",
  Soleil: "SW25.Races.Soleil",
  Alv: "SW25.Races.Alv",
  Lildraken: "SW25.Races.Lildraken",
  Valkyrie: "SW25.Races.Valkyrie",
  Spriggan: "SW25.Races.Spriggan",
  Meria: "SW25.Races.Meria",
  Tiens: "SW25.Races.Tiens",
  Dhampir: "SW25.Races.Dhampir",
  Abyssborn: "SW25.Races.Abyssborn",
  Arbor: "SW25.Races.Arbor",
  BabaYaga: "SW25.Races.BabaYaga",
  Basilisk: "SW25.Races.Basilisk",
  BrokenDrake: "SW25.Races.BrokenDrake",
  Centaur: "SW25.Races.Centaur",
  DarkDwarf: "SW25.Races.DarkDwarf",
  DarkTroll: "SW25.Races.DarkTroll",
  Dawn: "SW25.Races.Dawn",
  Diablo: "SW25.Races.Diablo",
  Drake: "SW25.Races.Drake",
  Fey: "SW25.Races.Fey",
  Fluorite: "SW25.Races.Fluorite",
  Kobold: "SW25.Races.Kobold",
  Lamia: "SW25.Races.Lamia",
  Lizardman: "SW25.Races.Lizardman",
  Lycanthrope: "SW25.Races.Lycanthrope",
  Lykant: "SW25.Races.Lykant",
  MagitechAngel: "SW25.Races.MagitechAngel",
  Miakis: "SW25.Races.Miakis",
  Newman: "SW25.Races.Newman",
  Scissorscorpion: "SW25.Races.Scissorscorpion",
  Sentian: "SW25.Races.Sentian",
  Vulcan: "SW25.Races.Vulcan",
  Weakling: "SW25.Races.Weakling"
};
...
SW25.itemTypeList = [
  { type: "weapon", label: "TYPES.Item.weapon" },
  { type: "armor", label: "TYPES.Item.armor" },
  { type: "accessory", label: "TYPES.Item.accessory" },
  { type: "item", label: "TYPES.Item.item" },
  { type: "spell", label: "TYPES.Item.spell" },
  { type: "enhancearts", label: "TYPES.Item.enhancearts" },
  { type: "magicalsong", label: "TYPES.Item.magicalsong" },
  { type: "ridingtrick", label: "TYPES.Item.ridingtrick" },
  { type: "alchemytech", label: "TYPES.Item.alchemytech" },
  { type: "phasearea", label: "TYPES.Item.phasearea" },
  { type: "tactics", label: "TYPES.Item.tactics" },
  { type: "infusion", label: "TYPES.Item.infusion" },
  { type: "barbarousskill", label: "TYPES.Item.barbarousskill" },
  { type: "essenceweave", label: "TYPES.Item.essenceweave" },
  { type: "otherfeature", label: "TYPES.Item.otherfeature" },
  { type: "check", label: "TYPES.Item.check" },
  { type: "resource", label: "TYPES.Item.resource" },
  { type: "combatability", label: "TYPES.Item.combatability" },
  { type: "skill", label: "TYPES.Item.skill" },
  { type: "raceability", label: "TYPES.Item.raceability" },
  { type: "language", label: "TYPES.Item.language" },
  { type: "monsterability", label: "TYPES.Item.monsterability" },
  { type: "action", label: "TYPES.Item.action" },
  { type: "session", label: "TYPES.Item.session" }
];
